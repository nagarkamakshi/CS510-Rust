...
void dijkstra(int graph[V][V], int src)
{
	...
	// The output array. dist[i]	// will hold the shortest	// distance from src to i	int dist[V];
	...
	for (int count = 0; count < V - 1; count++)
	{
		...
		for (int v = 0; v < V; v++)
			...
			// Update dist[v] only if is	// not in sptSet, there is	// an edge from u to v, and	// total weight of path from// src to v through u is smaller
